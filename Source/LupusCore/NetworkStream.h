    ...
    namespace Net {
        namespace Sockets {
            ...
            public:
                ...
                virtual void ReadAsync(std::vector<uint8_t>& buffer, size_t offset, size_t size, std::function<void(std::exception_ptr, Stream*, int)> callback) NOEXCEPT override;
                virtual void WriteAsync(const std::vector<uint8_t>& buffer, size_t offset, size_t size, std::function<void(std::exception_ptr, Stream*, int)> callback) NOEXCEPT override;
