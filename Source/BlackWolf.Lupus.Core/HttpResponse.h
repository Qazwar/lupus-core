...
namespace Lupus {
    ...
    namespace Net {
        ...
        public:
            ...
            virtual std::shared_ptr<Text::Encoding>& ContentEncoding() NOEXCEPT;
            ...
            virtual std::shared_ptr<Version>& ProtocolVersion() NOEXCEPT;
